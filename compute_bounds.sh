...
python src/compute_bounds.py sample_inputs/birdcage_occ.npz trees/tree_birdcage_adaptive.npz --max_split_depth 30
python src/compute_meshes.py trees/tree_birdcage_adaptive.npz meshes/mesh_birdcage_adaptive.npz
